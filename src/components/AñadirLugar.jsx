    ...
    return (
        <div className="añadir-lugar">
            ...
            <form onSubmit={(e) => { enviarFormulario(e) }}>
                ...
                <input className="input" type="text" name="nombre" onChange={(e) => (setCodigo_postal(e.target.value))} />
                <label className="label">Municipio</label>
                <input className="input" type="text" name="municipio" onChange={(e) => (setMunicipio(e.target.value))} />
                <label className="label">Localidad</label>
                <input className="input" type="text" name="imagen" onChange={(e) => (setLocalidad(e.target.value))} />
